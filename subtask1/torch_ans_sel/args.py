...
def get_args():
    parser = ArgumentParser(description="NOESIS")
    ...
    parser.add_argument('--bpe_model', type=str, default='/home/debanjan/projects_deep/NOESIS-II_deep/subtask1/data/Task_1/ubuntu/bpe_ubuntu.model', help='bpe model file')
    parser.add_argument('--train_inp', type=str, default='/home/debanjan/projects_deep/NOESIS-II_deep/subtask1/data/Task_1/ubuntu/task-1.ubuntu.train.json', help='input training json file')
    parser.add_argument('--val_inp', type=str, default='/home/debanjan/projects_deep/NOESIS-II_deep/subtask1/data/Task_1/ubuntu/task-1.ubuntu.dev.json', help='input validation json file')
    ...
    parser.add_argument('--resp_len', type=int, default=50)
